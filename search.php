      ...
      <div class="container">
        <div class="row">
                ...
                <div class="post-container">
                  ...
                  <?php
                    ...
                    if(isset($_GET['search'])){
                        $searsh_term = mysqli_real_escape_string($conn,$_GET['search']); 
                    }
                    ?>
                    <h2 class="page-heading">Search :<?php echo $searsh_term ?></h2>
                <?php
                            include "config.php";
                            ...
                            where post.title like '%{$searsh_term}%'
                    ...
                    $sqli = "SELECT * FROM post where post.title like '%{$searsh_term}%'";
         ...
         if($page > 1){
             ...
             echo "<li><a href='index.php?searsh='.$searsh_term.'&page=".($page - 1)."'>last</a></li>";
         }
            ...
            echo " <li class='".$activ."' ><a href='index.php?searsh='.$searsh_term.'&page=".$i."'>".$i."</a></li>";
         }
         
         if($tottle_page > $page){

             echo "<li><a href='index.php?searsh='.$searsh_term.'&page=".($page + 1)."'>Next</a></li>";
         }
