<?php include 'header.php'; ?>
 ...
 $row12 = mysqli_fetch_assoc($result1);
                    ?>
                    <h2 class="page-heading"><?php echo $row12['username']; ?></h2>
                <?php
                            include "config.php";
         ...
         if($page > 1){
             ...
             echo "<li><a href='index.php?aid='.$auth_id.'&page=".($page - 1)."'>last</a></li>";
         }
            ...
            echo " <li class='".$activ."' ><a href='index.php?aid='.$auth_id.'&page=".$i."'>".$i."</a></li>";
         }
